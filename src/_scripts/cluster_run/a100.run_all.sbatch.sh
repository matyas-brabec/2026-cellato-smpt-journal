...
#SBATCH --gres=gpu:A100        # GPU resource
#SBATCH -o ../__slurm__/a100_job-%j.out        # output file (%j expands to job ID)
...
mkdir -p ./results
python ./run_all.py $@ > ./results/a100_cuda_test_${ID}_${RAND_3_LETTERS}.csv
